...
-->
		...
		<div class="topNav">
				...
				<a  href="today_upload.php" class="active"> <span class="icon-circle-arrow-up"></span>Today Farmer Upload</a>
				 ...
				 <br>
                     <table class="table table-bordered">  
                          ...
                          <?php   
						  $date=date("Y-m-d");
						  $query = "SELECT * FROM `farmerupload`";
					...
					?>
						...
						<td> <?php echo $result['weight'];    ?></td>
						 <?php 
							   ...
							   <td><strong><font color="green"><?php echo $result['payment']; ?></td>
							   <?php 
							   }
							   else{ ?>
								   <td><strong><font color="red"><?php echo $result['payment']; ?></td>
								   <?php
							   }
							   ?>
							   <?php 
							   if($result['payment']=="Not Paid"){ ?>
                               <td><a href="today_upload.php?action=delivered&recv=<?php echo $result["mobile"];?>" onclick="JavaScript:Auto()"><span class="defaultBtn">Not Paid</span></a></td>  
                              <?php 
							   }
							   else{ ?>
							   <td><font color="#58ac18">Paid</td>
							      <?php
							   }
							   ?>
...
if(isset($_GET["action"]))  
 {  
      ...
      {  
			...
			$query="UPDATE `farmerupload` SET `payment`='".$pay."' WHERE `mobile`=".$_GET["recv"]." ";
